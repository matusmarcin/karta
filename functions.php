...
function karta_widgets_init() {
	...
	register_sidebar( array(
		...
		'before_widget' => '<div class="col-xs-12 col-sm-4 widget-area"><section id="%1$s" class="site-footer-widget %2$s">',
	...
	register_sidebar( array(
		...
		'before_widget' => '<div class="col-xs-12 widget-area"><section id="%1$s" class="site-wide-widget %2$s">',
		'after_widget'  => '</section></div>',
	...
	register_sidebar( array(
		...
		'before_widget' => '<div class="newsletter-area-center widget-area row"><div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3"><section id="%1$s" class="site-center-widget %2$s">',
